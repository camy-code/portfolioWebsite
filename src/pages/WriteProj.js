...
const WriteProj = () => {
    ...
    const handleCreate = async() => {
      ...
      try {
        ...
        await addDoc(collection(db, 'projPost'), { // The differnce in the s is tilting
          title:title,
          desc:desc,
          post:post,
          imageUrl:imageUrl,
        ...
        alert('Proj post submitted successfully!');
    ...
    return <><Grid  container direction={"column"} justifyContent={"flex-start"} alignItems={"center"} spacing={2} marginTop={4}>
        <Grid item ><Typography variant="h4" align="left" sx={{marginLeft:"5vh", marginRight:"95vh"}}>Project</Typography></Grid>
